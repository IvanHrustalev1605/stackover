...
@Getter
@Setter
@Schema(description = "комментарий для ответа на вопрос")
public class CommentAnswerDto {
    ...
    private String text;
    @Schema(description = "id комментатора")
    private Long userId;
    @Schema(description = "ссылка на аватарку комментатора")
    private String imageLink;
    @Schema(description = "репутация комментатора")
